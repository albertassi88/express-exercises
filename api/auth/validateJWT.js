...
try {
  const decoded = jwt.verify(token, segredo); //Através do método verify, podemos validar e decodificar o nosso JWT.
  ...
  next(); //Por fim, chamamos o próximo middleware que, no nosso caso, é a própria callback da rota.    
  } catch (err) {
